  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link text-white " href="../pages/teachers.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              ...
              <p class="mb-0 font-weight-normal text-sm">
               Software Developer(Still under training)
              </p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <p class="text-sm">
                    Hi there, I'm Shanjeevi and i am on my way to becoming a great developer. After that i am going to persue my dream to become a pilot. Yes from being SDE to becoming a pilot doesn't make any sense but i have to do it. changing dream into reality.
                  </p>
                  <hr class="horizontal gray-light my-4">
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; Shanjeevi CK</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; 95009500</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong> &nbsp; ckshanjeevi@mail.com</li>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="copyright text-center text-sm text-muted text-lg-start">
              ...
              <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Shanjeevi CK of Rnd Softech</a>
